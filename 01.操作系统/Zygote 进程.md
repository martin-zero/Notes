...
> Zygote 是 Android 中**所有 Java 进程的父进程**。它在 init.rc 中声明，由 [[Init 进程|Init]] 拉起，负责预加载 Framework 资源并 fork 出 [[SystemServer 启动|SystemServer]]。之后进入无限循环，通过 socket 等待 AMS 的 fork 指令来创建应用进程。
